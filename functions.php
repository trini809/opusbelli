...
function enqueue_parent_styles() {
    wp_enqueue_style( 'parent-style', get_template_directory_uri().'/style.css', array(), '1.0.2', "all" );
}
...
function my_bootstrap_include() {
  ...
  wp_enqueue_script( 'lp-script', get_template_directory_uri() . '-child/js/lp-script.js', array(), '1.0.1', true );
}
